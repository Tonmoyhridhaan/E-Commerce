            ...
            <div class="card bg-light text-dark">
                <div class="row">
                    ...
                    <div class="col-md-12 mt-0 mb-5 ml-1">
                        <h2 class="text-center">All  Block Products List</h2>
                        <table class="table table-striped" id = "blockproducts">
                        <thead>
                        <tr>
                            <th></th>
                            <th>ID</th>
                        ...
                        <td></td>
                                ...
                                <td>                                
                                    <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#myModal<?php echo $row['p_id'];?>">Unlock</a>
                                        ...
                                        <div class="modal-footer">
                                            <a class = "btn btn-primary" href ="unblock_product.php?id=<?php  echo $row['p_id']?>">yes</a>
