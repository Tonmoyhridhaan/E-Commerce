            ...
            <div class="card bg-light text-dark">
                <div class="row">
                    ...
                    <div class="col-md-12 mt-0 mb-5 ml-1">
                        <h2 class="text-center">All Request  Products List</h2>
                        <table class="table table-striped" id = "requestproducts">
                        <thead>
                        <tr>
                            <th></th>
                            <th>ID</th>
                        ...
                        <td></td>
                                ...
                                <td>                                
                                    <a class="btn btn-success" data-bs-toggle="modal" data-bs-target="#myModal1<?php echo $row['p_id'];?>">Approve</a>
