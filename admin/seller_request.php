            ...
            <div class="card bg-light text-dark">
                <div class="row">
                    ...
                    <div class="col-md-12 mt-0 mb-5 ml-1">
                        <h2 class="text-center">All Request Sellers List</h2>
                        <table class="table table-striped" id = "requestsellers">
                        <thead>
                            <tr>
                                <th></th>
                                <th>Id</th>
                        ...
                        <?php
                            ...
                            include 'include/connection.php';
                            $query = "select * from sellers where status='2'";
                        ...
                        <tr>
                                ...
                                <td>                                
                                    <a class="btn btn-success" data-bs-toggle="modal" data-bs-target="#myModal1<?php echo $row['s_id'];?>">Approve</a>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-header">
                                            <h4 class="modal-title">Approve Confermation!</h4>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>

                                        <!-- Modal body -->
                                        <div class="modal-body">
                                            Are you Sure to approve <b><?php echo $row['name'];?></b>?
                                        </div>
                                        <!-- Modal footer -->
                                    ...
                                    <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#myModal<?php echo $row['s_id'];?>">Delete</a>
